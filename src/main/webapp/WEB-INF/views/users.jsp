...
<div id="userAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/user/page/user-add'" style="width:800px;height:600px;padding:10px;">
        The window content.
</div>
...
var toolbar = [{
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var selectData=$("#userList").datagrid("getSelections");
...
function doEdit(){
        ...
        var rowData = JSON.stringify(sels[0]);
       /*  var data = $("#userList").datagrid("getSelected"); */
        //rowData= rowData.substring(1,rowData.length-1);
      //  alert(rowData);
      $('#userAdd').window('open'); 
      $('#content').form('load', sels[0]);
        
       
        
        
   /*  location.href="/user/queryUserById"; */
